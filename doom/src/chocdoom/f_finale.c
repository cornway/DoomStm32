...
void F_CastDrawer (void)
{
    ...
    V_DrawPatch (0, 0, (patch_t *)W_CacheLumpName (DEH_String("BOSSBACK"), PU_CACHE));
...
void F_BunnyScroll (void)
{
    ...
    p1 = (patch_t *)W_CacheLumpName (DEH_String("PFUB2"), PU_LEVEL);
    p2 = (patch_t *)W_CacheLumpName (DEH_String("PFUB1"), PU_LEVEL);
...
static void F_ArtScreenDrawer(void)
{
    ...
    else
    {
        ...
        V_DrawPatch (0, 0, (patch_t *)W_CacheLumpName(lumpname, PU_CACHE));
    }
}
