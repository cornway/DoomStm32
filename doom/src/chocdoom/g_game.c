...
extern int             deathmatch;           	// only if started as net death 
...
extern int             displayplayer;          // view being displayed 
extern int             levelstarttic;          // gametic at level start 
extern int             totalkills, totalitems, totalsecret;    // for intermission 
 
extern char           *demoname;
extern boolean         demorecording; 
extern boolean         longtics;               // cph's doom 1.91 longtics hack
extern boolean         lowres_turn;            // low resolution turning for longtics
...
extern boolean         testcontrols;    // Invoked by setup to test controls
...
{ 
    ...
    if (strafe) { 
        ...
        cmd->angleturn = cmd->angleturn + t_angleturn;
    }
