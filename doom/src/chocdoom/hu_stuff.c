...
#define HU_TITLEX	0
#define HU_TITLEY	(167 - READ_LE_I16(hu_font[0]->height))

#define HU_INPUTTOGGLE	't'
#define HU_INPUTX	HU_MSGX
#define HU_INPUTY	(HU_MSGY + HU_MSGHEIGHT*(READ_LE_I16(hu_font[0]->height) +1))
...
void HU_Ticker(void)
{
	    ...
	    || (plr->message && message_dontfuckwithme))
	{
	    ...
	    char msg_buf[64];
	    M_snprintf(msg_buf, sizeof(msg_buf), "FPS : %d(%d ms)",
