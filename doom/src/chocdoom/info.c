...
char *sprnames[] = {
    ...
    "HDB4","HDB5","HDB6","POB1","POB2","BRS1","TLMP","TLP2", "SAR2", NULL
};
...
state_t	states[NUMSTATES] = {
    ...
    {SPR_SPEC,0,10,{A_Look},S_SPEC_STND2,0,0},	// S_SPEC_STND
    {SPR_SPEC,1,10,{A_Look},S_SPEC_STND,0,0},	// S_SPEC_STND2
    {SPR_SPEC,0,2,{A_Chase},S_SPEC_RUN2,0,0},	// S_SPEC_RUN1
    {SPR_SPEC,0,2,{A_Chase},S_SPEC_RUN3,0,0},	// S_SPEC_RUN2
    {SPR_SPEC,1,2,{A_Chase},S_SPEC_RUN4,0,0},	// S_SPEC_RUN3
    {SPR_SPEC,1,2,{A_Chase},S_SPEC_RUN5,0,0},	// S_SPEC_RUN4
    {SPR_SPEC,2,2,{A_Chase},S_SPEC_RUN6,0,0},	// S_SPEC_RUN5
    {SPR_SPEC,2,2,{A_Chase},S_SPEC_RUN7,0,0},	// S_SPEC_RUN6
    {SPR_SPEC,3,2,{A_Chase},S_SPEC_RUN8,0,0},	// S_SPEC_RUN7
    {SPR_SPEC,3,2,{A_Chase},S_SPEC_RUN1,0,0},	// S_SPEC_RUN8
    {SPR_SPEC,4,8,{A_FaceTarget},S_SPEC_ATK2,0,0},	// S_SPEC_ATK1
    {SPR_SPEC,5,8,{A_FaceTarget},S_SPEC_ATK3,0,0},	// S_SPEC_ATK2
    {SPR_SPEC,6,8,{A_SargAttack},S_SPEC_RUN1,0,0},	// S_SPEC_ATK3
    {SPR_SPEC,7,2,{NULL},S_SPEC_PAIN2,0,0},	// S_SPEC_PAIN
    {SPR_SPEC,7,2,{A_Pain},S_SPEC_RUN1,0,0},	// S_SPEC_PAIN2
    {SPR_SPEC,8,8,{NULL},S_SPEC_DIE2,0,0},	// S_SPEC_DIE1
    {SPR_SPEC,9,8,{A_Scream},S_SPEC_DIE3,0,0},	// S_SPEC_DIE2
    {SPR_SPEC,10,4,{NULL},S_SPEC_DIE4,0,0},	// S_SPEC_DIE3
    {SPR_SPEC,11,4,{A_Fall},S_SPEC_DIE5,0,0},	// S_SPEC_DIE4
    {SPR_SPEC,12,4,{NULL},S_SPEC_DIE6,0,0},	// S_SPEC_DIE5
    {SPR_SPEC,13,-1,{NULL},S_NULL,0,0},	// S_SPEC_DIE6
    {SPR_SPEC,13,5,{NULL},S_SPEC_RAISE2,0,0},	// S_SPEC_RAISE1
    {SPR_SPEC,12,5,{NULL},S_SPEC_RAISE3,0,0},	// S_SPEC_RAISE2
    {SPR_SPEC,11,5,{NULL},S_SPEC_RAISE4,0,0},	// S_SPEC_RAISE3
    {SPR_SPEC,10,5,{NULL},S_SPEC_RAISE5,0,0},	// S_SPEC_RAISE4
    {SPR_SPEC,9,5,{NULL},S_SPEC_RAISE6,0,0},	// S_SPEC_RAISE5
    {SPR_SPEC,8,5,{NULL},S_SPEC_RUN1,0,0},	// S_SPEC_RAISE6
};
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
	...
	3,		// damage
	sfx_dmact,		// activesound
	MF_SOLID|MF_SHOOTABLE|MF_FLOAT|MF_NOGRAVITY|MF_SHADOW,		// flags
	S_NULL		// raisestate
    },
	...
	3,		// damage
	sfx_None,		// activesound
	MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY|MF_NOCLIP|MF_SHADOW,		// flags
	S_NULL		// raisestate
    },
	...
	0,		// damage
	sfx_None,		// activesound
	MF_NOBLOCKMAP|MF_NOSECTOR|MF_SHADOW,		// flags
	S_NULL		// raisestate
    },
