...
#define STACK_SIZE		0x00000400 // 1 KB
...
{
	/*----------Core Exceptions------------------------------------------------ */
	(void *)&stack[STACK_SIZE],     /*!< The initial stack pointer         */
...
void Default_Handler (void)
{
	d_printf ("unexpected interrupt received!\n");
